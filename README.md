Приложение создано записи и хранения информации по выполненным работам сервисным инженером. Для хранения информации в базе данных используется библиотека Room.
